 ...
 * to clean up.
 */
public class ColSort extends Iterator implements GlobalConst
{
        ...
        for (i=0; i<n_R_runs; i++) {
            ...
            try {
             //   temp_tuple.setHdr(n_cols, _in, str_lens);
                temp_tuple.new_setHdr(n_cols, _in);
	...
	*/
            ...
            Exception
    {
        ...
        //    lastElem.setHdr(n_cols, _in, str_lens);
            lastElem.new_setHdr(n_cols, _in);
        }
        catch (Exception e) {
        ...
        while ((p_elems_curr_Q + p_elems_other_Q) < max_elems) {
            ...
            cur_node = new pnode();
            cur_node.tuple = new Tuple(0,tuple);// tuple copy needed --  Bingjie 4/29/98
        ...
        if (i_buf[cur_node.run_num].empty() != true) {
           ...
           // System.out.println(tuple_size);
            ...
            //    new_tuple.setHdr(n_cols, _in, str_lens);
                new_tuple.new_setHdr(n_cols, _in);
            }
            catch (Exception e) {
                throw new SortException(e, "Sort.java: setHdr() failed");
            }
	...
	*/
            ...
            Exception
    {
      ...
      //      System.out.println(Convert.getIntValue(0, op_buf.getTupleByteArray()));
       //     System.out.println(Convert.getIntValue(4, op_buf.getTupleByteArray()));
            return output_tuple;
        }
        else
            return null;
